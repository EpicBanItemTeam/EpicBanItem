...
public class CommonUpdateOperation extends AbstractMap<DataQuery, UpdateOperation> implements UpdateOperation {
    ...
    public UpdateOperation merge(UpdateOperation another) {
        ...
        another.forEach((query, operation) -> operations.compute(query, (k, v) -> {
            if (Objects.isNull(v)) {
                return operation;
            } else {
