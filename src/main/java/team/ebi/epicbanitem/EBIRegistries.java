    ...
    public void onRegisterRegistry(RegisterRegistryEvent.EngineScoped<Server> event) {
        event.register(
                ...
                () -> ImmutableMap.<ResourceKey, RestrictionTrigger>builder()
                        ...
                        .put(EpicBanItem.key("pickup"), injector.getInstance(PickupRestrictionTrigger.class))
                        .put(EpicBanItem.key("throw"), injector.getInstance(ThrowRestrictionTrigger.class))
                        //                        .put(EpicBanItem.key("drop"),
                        // injector.getInstance(DropRestrictionTrigger.class))
                        ...
                        .put(EpicBanItem.key("be_crafted"), injector.getInstance(BeCraftedRestrictionTrigger.class))
                        .put(EpicBanItem.key("craft"), injector.getInstance(CraftRestrictionTrigger.class))
                        .put(EpicBanItem.key("store"), injector.getInstance(StoreRestrictionTrigger.class))
