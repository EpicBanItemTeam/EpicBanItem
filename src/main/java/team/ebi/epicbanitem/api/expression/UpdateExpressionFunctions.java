...
public final class UpdateExpressionFunctions {
    ...
    private static DefaultedRegistryReference<UpdateExpressionFunction> key(final ResourceKey location) {
        return RegistryKey.of(EBIRegistries.UPDATE_EXPRESSION, location).asDefaultedReference(Sponge::server);
    }
}
